...
# Mod by Darkmoon for Adding OCS Panel
# 
# ==================================================
...
state=Naga_City
locality=Naga_City
organization=HostingLimited_Philippines
organizationalunit=IT
commonname=HostingLimited_Philippines
email=schemerzye@gmail.com
...
echo "<pre>Setup by Darkmoon</pre>" > /home/vps/public_html/index.html
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://github.com/darkmoonoffical/VPSAutoScrptz/blob/master/client-1194.conf"
...
# konfigurasi openvpn
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://github.com/darkmoonoffical/VPSAutoScrptz/blob/master/client-1194.conf"
...
echo "OpenVPN  : TCP 465 (client config : http://$MYIP:81/client.ovpn)"  | tee -a log-install.txt
